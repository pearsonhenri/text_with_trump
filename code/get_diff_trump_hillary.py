...
for i in range(0, 50):
    print trump_diff_array[i][0] + "     wordcount: " + str(trump_diff_array[i][1]) + "    frequency factor: " + str(trump_diff_array[i][3])
...
# for i in range(0, 50):
#     print hillary_diff_array[i][0] + "     wordcount: " + str(hillary_diff_array[i][1]) + "    frequency factor: " + str(hillary_diff_array[i][3])
